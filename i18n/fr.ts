...
L'équipe {appName}`,
	...
	tutorSearch: {
		...
		about: 'À Propos',
		tutorNotFound: 'Tuteur non trouvé',
		errorLoadingTutor: 'Erreur lors du chargement des détails du tuteur',
		loadingTutor: 'Chargement des détails du tuteur...',
		categorySeparator: ' / ',
		contactButton: 'Contacter le Tuteur',
		contactModalTitle: 'Contacter {tutorName}',
		contactMessageTemplate:
			'Bonjour {tutorName},\n\nJe souhaiterais retenir vos services de tutorat.\n\nMes coordonnées :\nEmail : {userEmail}\nTéléphone : {userPhone}\n\nMerci !',
		contactMessagePlaceholder: 'Modifiez votre message...',
		...
		signInToContact: 'Veuillez vous connecter pour contacter ce tuteur.',
		contactEmailSubject: 'Nouveau message de {userName} via TutorLux',
		contactEmailPostscript:
			'Découvrez TutorLux, une application de planification rapide et simple qui facilite la gestion de vos cours et rendez-vous. Visitez www.tutorlux.com pour en savoir plus !',
