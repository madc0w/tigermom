...
The {appName} Team`,
	...
	tutorSearch: {
		...
		contactModalTitle: 'Contact {tutorName}',
		contactMessageTemplate:
			'Hello {tutorName},\n\nI would like to retain your tutoring services.\n\nMy contact information:\nEmail: {userEmail}\nPhone: {userPhone}\n\nThank you!',
		contactMessagePlaceholder: 'Edit your message...',
		sendButton: 'Send Message',
		sendingButton: 'Sending...',
		cancelButton: 'Cancel',
		contactSuccess: 'Your message has been sent successfully!',
		contactError: 'Failed to send message. Please try again.',
		signInToContact: 'Please sign in to contact this tutor.',
		contactEmailSubject: 'New message from {userName} via TutorLux',
		contactEmailPostscript:
			'Check out TutorLux, a quick and simple scheduling app that makes managing your tutoring sessions and appointments easier. Visit www.tutorlux.com to learn more!',
